...
SELECT * FROM Customer;
SELECT * FROM Customer WHERE Contact LIKE '7%';
SELECT * FROM Customer WHERE Customer_id>2;
SELECT * FROM Customer WHERE Customer_name LIKE 'S%';
SELECT * FROM Customer WHERE Customer_name ='Shobhit';
...
UPDATE Products 
 SET Product_name = 'Fruits Beeries' WHERE Product_id = 1;
 
 UPDATE Products 
 SET Product_name = 'Fruits Banana' WHERE Product_id = 2;
 
 UPDATE Products 
 SET Product_name = 'Clothes T-shirts' WHERE Product_id = 3;
 
 UPDATE Products 
 SET Product_name = 'Clothes Gym wears' WHERE Product_id = 4;
 
 UPDATE Products 
 SET Product_name = 'Stationary Pen' WHERE Product_id = 5;
 
 UPDATE Products 
 SET Product_name = 'Mobile Phones Samsung ' WHERE Product_id = 7;
...
INSERT INTO Products VALUES (19,'Mobile Phones Redmi',10000,'Image Available');
INSERT INTO Products VALUES (20,'Mobile Phones MI',12000,'Image Available');
...
CREATE TABLE Your_orders (
 ...
 ALTER TABLE Your_orders ADD FOREIGN KEY(Product_id) REFERENCES Products(Product_id);
...
INSERT INTO Order_report VALUES(7,'Confirmed',7);
...
CREATE TABLE Stock (
 ...
 UPDATE Stock 
  SET date_of_added = '2021-02-15' WHERE Product_id = 20;
...
INSERT INTO Admin VALUES('admin',12345);
 ...
 UPDATE Categories 
  SET Category_name ='Fruits' WHERE Product_id=8;
 ...
 */
 ...
 SELECT * FROM Stock WHERE date_of_added > '2021/01/01';
 
 SELECT  * FROM Products WHERE Images = 'Image Not Available';
 
 SELECT * FROM Stock WHERE Quantity_left<50;
 
 SELECT Product_id FROM Stock WHERE Quantity_left<50;
 ...
 7. QUANTITY IS UNDER 50
 */
 
 SELECT * FROM  Your_orders WHERE Order_id<50;
 SELECT * FROM  Your_orders  ORDER BY Order_date ASC;
 SELECT * FROM Your_orders , Products 
  WHERE Your_orders.Product_id = Products.Product_id;
 ...
 SELECT * FROM Products , Stock
   ...
   */
   ...
   select P.*, S.quantity_left from products P inner join Stock S 
      ...
      SELECT Order_id , Order_date ,Price FROM  Your_orders LIMIT 10; 
	  ...
	  */
       ...
       */
       ...
       SELECT C.* FROM Customer C full outer join Your_orders Y

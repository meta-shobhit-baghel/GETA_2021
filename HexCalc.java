...
class  HexCalc {
 ...
 /**
   * receving  the  value  and  its  power
  */
 ...
 public static int power( int n , int p )
  ...
  public static String multiply(String str1,String str2)
   {
     ...
     return Decimal_to_Hexa( String.valueOf(k1*k2) );
   }
  ...
  public static String Decimal_to_Hexa( String str )
   {
  ...
  * returning  the  string  in  reverse  form
  */
...

 {
   ...
   String str2 = s.nextLine();
    ...
    System.out.println( Hex_to_Decimal(str1) );
    System.out.println( Decimal_to_Hexa(str1) );
